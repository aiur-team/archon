 ...
 *
 *   node --test hosted/test/publication-browser-binding.test.mjs
 */

import assert from "node:assert/strict";
import { test } from "node:test";

import { AuthStore, TRANSIENT_TTL_SECONDS } from "../lib/auth-store.mjs";
import { HostedContractError } from "../lib/contracts.mjs";
import { BINDING_COOKIE } from "../lib/identity.mjs";
import {
  decodeOperation,
  encodeOperation,
  issueBrowserBinding,

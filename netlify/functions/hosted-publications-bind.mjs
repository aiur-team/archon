...
import { CsrfFailedError } from "../lib/hosted/auth-errors.mjs";
import { LOGIN_COOKIE, clearCookie, readCookie, requireExactOrigin } from "../lib/hosted/identity.mjs";
import { issueBrowserBinding, releaseBrowserBinding } from "../lib/hosted/publication-browser-binding.mjs";
import { bindPublication } from "../lib/hosted/publications.mjs";
import {
  browserDependencies,
  browserError,
  browserJson,

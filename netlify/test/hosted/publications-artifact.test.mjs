 ...
 *
 *   node --test netlify/test/hosted/publications-artifact.test.mjs
 */
...
import { HOSTED_LIMITS, validateResult, validateWireError } from "../../lib/hosted/contracts.mjs";
import { completePublication } from "../../lib/hosted/publications.mjs";
import { createPublicationStore } from "../../lib/hosted/publication-store.mjs";
import { readArtifactBody } from "../../lib/hosted/artifact-body.mjs";
import artifactHandler, {
  handleArtifact,
  config as artifactConfig,
} from "../../functions/hosted-publications-artifact.mjs";
import { handleCancel } from "../../functions/hosted-publications-cancel.mjs";
import {
  FIXTURE_APP_ORIGIN,
  FIXTURE_HTML,
  FIXTURE_KEY,

 ...
 *
 *   node --test netlify/test/hosted/publications-agent.test.mjs
 */
...
import { PRIVATE_RESPONSE_HEADERS } from "../../lib/hosted/publications-http.mjs";
import startHandler, { handleStart, config as startConfig } from "../../functions/hosted-publications-start.mjs";
import statusHandler, {
  handleStatus,
  config as statusConfig,
} from "../../functions/hosted-publications-status.mjs";
import cancelHandler, {
  handleCancel,
  config as cancelConfig,
} from "../../functions/hosted-publications-cancel.mjs";
import {
  FIXTURE_APP_ORIGIN,
  FIXTURE_HTML,
  FIXTURE_KEY,
